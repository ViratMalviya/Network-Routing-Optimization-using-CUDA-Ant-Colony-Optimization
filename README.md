...
- **Execution Engine Indicator**: A real-time UI badge prominently displays whether the backend executed using `GPU Accelerated` native kernels or `CPU Fallback`.
